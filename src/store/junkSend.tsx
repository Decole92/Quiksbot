...
//   return (
//     <div
//       // className='fixed bottom-5 right-2.5 z-50 flex flex-col items-end space-y-4'
//       className='fixed bottom-1 right-2.5 md:bottom-5 md:right-5 z-50 flex flex-col items-end transition-transform duration-500'
//     >
//       {botOpened && bot && (
//         <div className='flex h-[800px] w-full max-w-[500px] flex-col overflow-hidden rounded-xl border bg-white shadow-lg dark:bg-gray-900'>
