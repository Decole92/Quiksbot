...
function Mainheader() {
  ...
  return (
    <header className='h-25 bg-transparent dark:bg-transparent dark:text-gray-400 sticky top-0 backdrop-blur-sm z-10  mb-2'>
      <Banner />
      <div className='flex items-center  lg:px-6 p-2'>
        <Link
          title='homepage'
        ...
        >
          ...
          <div className='-space-y-0.5 lg:space-y-1 md:space-y-1'>
            <h3 className='font-thin text-black text-2xl dark:text-[#E1B177] uppercase tracking-widest'>
              Quiksbot
            </h3>
