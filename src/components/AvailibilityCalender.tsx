          ...
          <Card className='p-5 hover:shadow-lg transition-shadow'>
            ...
            >
              ...
              <h3 className='text-xs p-2 text-gray-900 dark:text-gray-500'>
                ...
                &ldquo;Follow-up&rdquo;). <br />
                Usage Tip: For optimal performance with this chatbot type, we
                ...
                , as it delivers superior results tailored to this
                functionality.
              </h3>
                ...
                <Accordion type='single' collapsible className='w-full'>
                  {appointments && appointments.length > 0 ? (
                    appointments.map((appointment) => (
                      <AccordionItem
                        key={appointment._id as string}
                        value={appointment._id as string}
                      >
                        <div className='flex items-center w-full'>
                          <Trash2Icon
                            onClick={() => handleDel(appointment?._id as string)}
